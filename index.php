      ...
      <nav class="collapse navbar-collapse main-navbar logo-navbar navbar-right">
        ...
        <div class="menu-container">
          ...
          <ul class="nav navbar-nav" id="menu-main">
            ...
            <li class="menu-item active"  id="man_id1"> <a href="index.php">Home</a> </li>
...
<div id="content" role="main">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      ...
      <div class="carousel-caption">
          <h3></h3>
         <span class="slide-meta-author"><span class="td-post-author-name"><span class="span-dash">-</span> </span><span class="td-post-date"></span><span class="span-space"></span></span>
	 ...
	 <div class="item">
      ...
      <div class="carousel-caption">
          <h3></h3>
         <span class="slide-meta-author"><span class="td-post-author-name"><span class="span-space"></span></span>
        </div>
    </div>
	 ...
	 <div class="item">
      ...
      <div class="carousel-caption">
          <h3></h3>
        <span class="slide-meta-author"><span class="td-post-author-name"><span class="span-dash">-</span> </span><span class="td-post-date"></span></span>
        </div>
    </div>
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
	...
	<div><h1 class="text-center" data-os-animation="fadeIn" data-os-animation-delay="0s" style="color:Tomato;">  We are an operational NGO that plan and carry out boots-on-the-ground projects to accomplish their objectives.</h1></div>
	<div><h2 class="text-center os-animation big-h2" style="color:Tomato;" > Welcome to our family</h2></div>
	<p class="read-btn"><a href="about-us.php">READ MORE</a></p>
	...
	$run_coment1=$db->select($query_comment1);
	$count_comment1=$run_coment1->num_rows;


	?>

    <h2 class="timer count-title count-number" data-to="<?php echo $count_comment1;?>" data-speed="100"></h2>
	...
	$run_coment=$db->select($query_comment);
	$count_comment=$run_coment->num_rows;


	?>
    <h2 class="timer count-title count-number" data-to="<?php echo $count_comment;?>" data-speed="1500"></h2>
